...
export function eventStatusLine(t: Translate, e: EventRow, rsvp: Rsvp | null, count: number, now: Date, tz: string | null): { text: string; tone: 'green' | 'muted' | 'maroon' | 'navy' } {
  ...
  return { text: t('events.statusOpen'), tone: 'maroon' };
}
